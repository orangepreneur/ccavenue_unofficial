...
import com.iammukesh.ccavenue_unofficial.Utility.LoadingDialog;
import com.iammukesh.ccavenue_unofficial.Utility.RSAUtility;
import com.iammukesh.ccavenue_unofficial.Utility.ServiceUtility;
    ...
    private class RenderView extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (!ServiceUtility.chkNull(vResponse).equals("")
                    ...
                    /// RSA & String buffer with Amount and Currency
                    /// using RSA generate Public Key
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                ...
                System.out.print("Avinash PostData -------"+postData);
                Log.i("Avinash", "onPostExecute: "+ postData);
                myBrowser.postUrl(mainIntent.getStringExtra(AvenuesParams.TRANS_URL), postData.getBytes());
